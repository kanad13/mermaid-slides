...
TypeScript, lint, unit, command-contract, documentation-integrity, and workflow gates, builds the web
and offline distributions, and then runs compatibility checks. Branch and pull-request runs do not
upload release artefacts or reach a publishing job.
